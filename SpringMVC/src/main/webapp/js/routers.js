...
var TodoRouter = Backbone.Router.extend({
    ...
    getTodo: function(id){
        ...
        */
        ...
        // Change the url
        this.navigate("todo/" + id + '/editThisTodoItem'); // updates the fragment for us, but doesn't trigger the 
    },
...
//begin monitoring all hashchange events as follows
Backbone.history.start();


//Go to and check console:
//http://localhost:8080/SpringMVC/backbone_routers.html#about ...

//Change url in browser and trigger a navigation event
myTodoRouter.navigate("search/trustmeIamdead", {trigger: true});

//Trigger 'route' event on router instance."
myTodoRouter.on('route', function(name, args) {
  console.log("Function callled "+ name + " with args "+args); 
});